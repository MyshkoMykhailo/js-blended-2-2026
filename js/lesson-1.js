...
// const num = prompt(
//   "введіть порядковий номер сезону (ціле число від 1 до 4 включно)",
// );
// let result = "";
// switch (num) {
//   case "1":
...
// const minutesNumber = prompt("enter the number of minutes");
// let time = 0;
// if (minutesNumber < 60) then;
...
//     }
//   }
//   return `сума парних чисел в діапазоні від ${min} до ${max} складе ${sum}`;
// }
// console.log(getNumbers(0, 10));
// console.log(getNumbers(0, 5));
// console.log(getNumbers(6, 8));
// console.log(getNumbers(9, 8));
